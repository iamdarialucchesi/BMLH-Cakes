        ...
        <div className="container-fluid bg-white section-padding">
            <div className="container">
                <div className="text-center">
                    <h1 className="font-family-rancho fw-500">Top Rated<span
                        className="text-primary">Products</span></h1>
                    <p className="p-site w-lg-75">A cake is the important sweet dish that gives a sweet touch to your <br/> celebration. It has become a compulsory part..</p>
                </div>
                    ...
                    <div className="col-12 col-md-6 col-lg-3 mb-3">
                        <div className="card">
                            <StaticImage src="../../images/home/items/8.png"
                                         className="rounded-top img-fluid" alt="A image title" placeholder="blurred"/>
                            <div className="card-body">
                                <h5 className="card-title">White Cake / Vanilla</h5>
                                <p className="p-site">3 cup all purpose flour | 4 egg | 2 teas-poon baking soda | 2 teaspoon vanilla essence</p>
                                <h6 className="text-primary fw-bold">$500.00</h6>
                                <div className="row mt-3">
                                    <div className="col-9 pe-0">
                    ...
                    <div className="col-12 col-md-6 col-lg-3 mb-3">
                        <div className="card">
                            <StaticImage src="../../images/home/items/3.png"
                                         className="rounded-top img-fluid" alt="A image title" placeholder="blurred"/>
                            <div className="card-body">
                                <h5 className="card-title">Devil's Food Cup Cake</h5>
                                <p className="p-site">3 cup all purpose flour | 4 egg | 2 teas-poon baking soda | 2 teaspoon vanilla essence</p>
                                <h6 className="text-primary fw-bold">$500.00</h6>
                                <div className="row mt-3">
                                    <div className="col-9 pe-0">
                    ...
                    <div className="col-12 col-md-6 col-lg-3 mb-3">
                        <div className="card">
                            <StaticImage src="../../images/home/items/4.png"
                                         className="rounded-top img-fluid" alt="A image title" placeholder="blurred"/>
                            <div className="card-body">
                                <h5 className="card-title">Gluten-free Persian cake</h5>
                                <p className="p-site">3 cup all purpose flour | 4 egg | 2 teas-poon baking soda | 2 teaspoon vanilla essence</p>
                                <h6 className="text-primary fw-bold">$500.00</h6>
                                <div className="row mt-3">
                                    <div className="col-9 pe-0">
                ...
                <div className="text-center">
                    <button className="btn btn-primary btn-site">See All Products</button>
                </div>
